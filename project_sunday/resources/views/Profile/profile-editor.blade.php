                            ...
                            <div class=" mx-auto mt-10  ">
                                <div class="w-full  m-auto items-center mx-auto p-3">
                                    <div class="bg-neutral-300   h-50px mb-3 dark:bg-gray-900 rounded-lg ">
                                        ...
                                        <input class="bg-neutral-300 rounded-lg h-30px  mt-2 dark:bg-gray-900 dark:text-white"
                                            placeholder="{{ $user->birthday }}" name="birthday" value="{{ $user->birthday }}" type="date">
                                    </div>
                                    <div class="bg-neutral-300  h-50px mb-3  dark:bg-gray-900 rounded-lg">
                                        <label class="ml-4 dark:text-white" for="">
                                            ตำบล:
