            ...
            <main class="h-full overflow-y-auto">
                <div class="px-6 mx-auto grid w-1250px ">
                                            ...
                                            @foreach ( $customers as $customer )
                                                <tr class="text-gray-700 dark:text-gray-400">
                                                    ...
                                                    <td class="px-4 py-3 text-sm"> <button
                                                            ...
                                                            type="button"
                                                            value="{{$customer}}"
                                                            onclick="toggleModal('modal-id')">รายละเอียด</button></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                    ...
                    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center"
                        id="modal-id">
                        <div class="relative w-1160px my-6 m-auto  ">
                            <!--content-->
                            <div
                                class="border-0 rounded-lg shadow-lg relative flex flex-col w-1160px bg-white outline-none focus:outline-none">
                                <!--header-->
                                <div
                                ...
                                <div class="relative p-6 flex-auto">
                                    <div class="w-full overflow-hidden rounded-lg shadow-xs mb-6 w-1115px">
                                        <div class="w-full overflow-x-auto ">
                                            <div class="w-full whitespace-no-wrap bg-EBEBEB h-100% rounded-md  mb-6 ">
                                                <div class="w-1060px  m-auto  text-xl mt-6 mb-6">
                                                    <p></p>
