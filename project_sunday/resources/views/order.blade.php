            ...
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul>
                    ...
                    <li class="relative px-6 py-3">
                        ...
                        <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:hover:text-gray-200 dark:text-gray-100"
                            href="/order">
                            <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                                stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"
                            ...
                            <div class=" m-auto w-500px mt-5 ">
                                <form class="w-full max-w-lg ">
                                    ...
                                    <div class="w-200px h-30px bg-pink  rounded mb-6 m-auto w-150px text-center p-1 ">
                                        <button class="text-white"><a href="/order-step-1">ถัดไป</a></button>
                                    </div>
                                </form>
                            </div>
                        </div>
