                                        ...
                                        @foreach ($province->city as $cityed)
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="flex px-4 py-3 text-sm ">
                                                    <a class="w-6 h-6 mr-2" href="{{route('city.edit',$cityed->id)}}">
                                                    ...
                                                    <form action="{{route('city.destroy',$cityed->id)}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button id="" class="w-6 h-6" onclick="javascript:return confirm('ต้องการลบอำเภอ')"><svg
