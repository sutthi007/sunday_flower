                ...
                <div class="px-6 mx-auto grid w-1250px">
                    ...
                    <div class="bg-EBEBEB h-100% ">
                        <div class="m-auto w-1115px  mt-16 ">
                            <div class="mb-6">
                                <div class="text-5xl text-center mb-6">
                                    <h1>สรุปบิล</h1>
                                </div>   
                            ...
                            <div class=" flex w-full justify-between ">
                                ...
                                <div class="p-2 w-200px  text-center ">
                                    <h1 class="text-2xl">สุทธิ แสนใจ</h1>
                                    <p>ทั้งหมด</p>
                                    <h1 class="text-2xl bg-pink text-white">1500</h1>
                                </div>
                            </div>
                            </div>
                                        ...
                                        <table class="w-full whitespace-no-wrap">
                                            ...
                                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                                <tr class="text-gray-700 dark:text-gray-400">
                                                    ...
                                                    <td class="px-4 py-3 text-sm">099888888</td>
