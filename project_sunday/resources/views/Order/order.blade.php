                ...
                <div class="container px-6 mx-auto grid  ">
                    ...
                    <div class="bg-white  rounded-lg shadow-lg dark:bg-gray-800">
                        <div class="m-auto  mt-4 ">  
                            ...
                            <div class="xl:w-600px md:w-full mt-5 m-auto ">
                                <form class="" action="{{ route('projects.store')}}" method="post">
                                    ...
                                    <div class="grid  gap-6 mb-86 md:grid-cols-2 xl:grid-cols-2 ">
                                        ...
                                        <div class="w-full  px-3  m-auto">
                                            ...
                                            <input class="appearance-none block w-full  text-gray-700 border  rounded py-3 px-4  leading-tight focus:outline-none focus:bg-white dark:text-white dark:bg-gray-900" type="tel"
