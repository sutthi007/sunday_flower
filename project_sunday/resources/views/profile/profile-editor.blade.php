                    ...
                    <div class="grid m-auto mb-8 md:grid-cols-1 xl:grid-cols-2 mt-6  ">
                        ...
                        <div class=" md:ml-0 xl:ml-3 mt-20px xl:mt-0 ">
                            ...
                            <div class=" bg-white h-400px mt-20px text-center  rounded-lg shadow-lg dark:bg-gray-800">
                                ...
                                <div class=" w-300px m-auto pt-15  ">
                                    <label class="dark:text-white" for="">
                                        เอกสารประจำประชาชน หน้า
                                    </label>
                                    <div class="bg-neutral-300  h-50px mb-3 m-auto w-300px dark:bg-gray-900">
                                        <input class="bg-neutral-300 rounded-lg h-30px mt-2 w-200px dark:bg-gray-800 dark:text-white" type="file">
                                    </div>
                                    ...
                                    <div class="bg-neutral-300 h-50px mb-3 m-auto dark:bg-gray-900">
                                        <input class="bg-neutral-300 rounded-lg h-30px mt-2 w-200px dark:bg-gray-800 dark:text-white" type="file">
                                    </div>
                                </div>
                            </div>
