                            ...
                            <table class="w-full whitespace-no-wrap">
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3 text-sm w-100px">นาย ตู่ จันทร์อังคาร</td>
                                        ...
                                        <td class="px-4 py-3 text-sm w-100px">
                                            <div class="bg-pink w-50px h-30px text-center rounded-md">
                                            <a class="text-white m-auto text-base" href="/employee-data">ดู</a>
                                        </div>
                                        </td>
