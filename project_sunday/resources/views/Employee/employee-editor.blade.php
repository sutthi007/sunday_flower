                ...
                <div class="px-6 mx-auto grid   ">
                    ...
                    <div class="bg-white w-1250px h-auto m-auto rounded-md">
                            ...
                            <div class="flex p-8 grid grid-cols-3 gap-4 ml-6  ">
                                <div class="bg-235 w-300px  h-40px mb-6">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-240px" type="text"  value="{{ $user->name }}" name="name">
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px ">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text" value="{{$user->role}}" disabled name="role">
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text" value="{{ $user->IDuser}}" disabled name="IDuser">
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px mb-6">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text" value="{{ $user->birthday }}" name="birthday">
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text" value="{{ $user->email }}" name="email">
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text" value="{{ $user->phone }}" name="phone">
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text" value="{{$user->address}}" name="address">
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text" value="{{ $user->city }}" name="city">
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text" value="{{$user->province}}" name="province">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class=" w-1115px  m-auto  mt-10 rounded-md  ">
                            ...
                            <button type="submit" class="bg-pink w-100px h-30px rounded-md text-white">บันทึก</button>
                            </div>
                        </div>
                    </div>
                </div>
