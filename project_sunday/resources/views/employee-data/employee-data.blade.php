                ...
                <div class="px-6 mx-auto grid   ">
                    ...
                    <div class="bg-white w-1250px h-auto m-auto rounded-md">
                            ...
                            <div class="flex p-8 grid grid-cols-3 gap-4 ml-6">
                                <div class="bg-235 w-300px  h-40px mb-6">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-240px" type="text"  placeholder="นาย ตู่ จันทร์อังคาร" disabled>
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px ">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text" placeholder="นายก" disabled>
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text" placeholder="2323232323" disabled>
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px mb-6">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text" placeholder="12/12/2512" disabled>
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text"placeholder="พระราม5" disabled>
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text"placeholder="121/1" disabled>
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text"placeholder="พระราม" disabled>
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text"placeholder="เมือง" disabled>
                                    </div>
                                </div>
                                <div class="bg-235 w-300px h-40px">
                                    <div class="p-2">
                                        ...
                                        <input class="bg-235 w-200px" type="text"placeholder="กรุงเทพ" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class=" w-1115px  m-auto  mt-10 rounded-md  ">
                            ...
                            <button class="bg-pink w-100px h-30px rounded-md text-white"><a href="/employee">ย้อนกลับ</a></button>
                            <button class="bg-pink w-100px h-30px rounded-md text-white"><a href="/employee-editor">แก้ไข้</a></button>
                            </div>
                        </div>
                    </div>
                </div>
